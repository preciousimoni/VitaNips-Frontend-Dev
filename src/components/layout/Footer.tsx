      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 relative z-10">
        ...
        <div className="border-t border-gray-100 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex space-x-4">
            <a href="https://x.com/VitaNipsHealth" target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-50 rounded-full text-gray-400 hover:text-primary-900 hover:bg-gray-100 transition-all transform hover:-translate-y-1">
            ...
            <a href="https://www.linkedin.com/company/vitanips/" target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-50 rounded-full text-gray-400 hover:text-primary-900 hover:bg-gray-100 transition-all transform hover:-translate-y-1">
            ...
            <a href="https://instagram.com/VitaNipsHealth" target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-50 rounded-full text-gray-400 hover:text-primary-900 hover:bg-gray-100 transition-all transform hover:-translate-y-1">
