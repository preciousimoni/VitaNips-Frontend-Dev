        ...
        <div className="flex justify-between mt-10 pt-6 border-t border-gray-100">
          ...
          {currentStep < steps.length ? (
            <div className="flex gap-3">
              {/* Show "Create Account" button on step 2 (Personal) to allow skipping health step */}
              {currentStep === 2 && (
                <button
                  type="submit"
                  disabled={isLoading}
                  className="flex items-center px-6 py-2.5 border border-transparent rounded-xl shadow-sm text-sm font-bold text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 disabled:opacity-50 disabled:cursor-not-allowed transition-transform transform hover:scale-[1.02]"
                >
              ...
              <button
                type="button"
                onClick={handleNext}
                className={`flex items-center px-6 py-2.5 border rounded-xl shadow-sm text-sm font-bold focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors ${
                  currentStep === 2 
                    ? 'border-gray-300 text-gray-700 bg-white hover:bg-gray-50' 
                    : 'border-transparent text-white bg-primary-600 hover:bg-primary-700'
                }`}
              >
                {currentStep === 2 ? 'Add Health Info (Optional)' : 'Next Step'}
